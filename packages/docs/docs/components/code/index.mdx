...
up in your project configuration file.
...
This sets `@lezer/javascript` up as the default parser for all your code
...
with `${}` syntax. In the example below, `${name}` is replaced with the value of
