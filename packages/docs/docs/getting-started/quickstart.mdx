...
Navigate to whichever directory you would like your new animation folder 
to be placed.  
...
Enter the name of your project (Ex] my-first-animation)

Enter the project path (Ex] my-first-animation)

Select which language you would like to use (TypeScript or plain 
JavaScript)
...
A new folder with the title of your project should appear in the directory 
that you selected.

Next, change into your newly created project directory.
(Ex] cd my-first-animation)

Run the following command in your newly
...
animations. Open `example.tsx` in a text editor (Ex] nano example.tsx), and replace all code in the
...
If you do not see the circle animation in the preview pane, try the following:

1. Open up a new terminal window

2. Navigate to the directory where you created your animation project (Ex] my-first-animation)

3. Run npm run serve

4. Copy and paste the new preview link with the new port number (Ex] http://localhost:9001/)
