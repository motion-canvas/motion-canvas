    ...
    const ui = await parseTypes(
      {
        ...
        excludePrivate: true,
        entryPoints: [
          '../2d/src/runtime/components',
          '../2d/src/runtime/curves',
          '../2d/src/runtime/decorators',
          '../2d/src/runtime/partials',
          '../2d/src/runtime/scenes',
          '../2d/src/runtime/utils',
        ],
        tsconfig: '../2d/src/runtime/tsconfig.json',
      },
      '2d',
      core,
    );
