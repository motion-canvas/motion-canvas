...
export default makeScene2D(function* (view) {
  ...
  yield* waitFor(2);
  yield* tex().tweenTex('x = \\sin \\left( \\frac{\\pi}{2} \\right) + 3', 1);
  yield* tex().tweenTex(
    'x = 1 + \\sin \\left( \\frac{\\pi}{2} \\right) + 3',
    1,
  );
  yield* tex().tweenTex(
    'x = 3 + \\sin \\left( \\dfrac{\\pi}{2} \\right) + 1',
    1,
  );
  yield* tex().tweenTex(
  ...
  yield* tex().tweenTex('x = \\sin \\left( \\frac{\\pi}{2} \\right)', 1);
  yield* waitFor(2);
});
